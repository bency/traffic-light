...
<head>
    ...
    @vite(['resources/css/traffic-light.css', 'resources/js/traffic-light-create.js', 'resources/css/app.css'])
</head>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="traffic-settings border p-3" id="traffic-settings">
                    ...
                    <div>
                        <input type="text" id="new-cycle-name" class="form-control mb-2" placeholder="輸入路口名稱">
                        <button id="add-cycle" class="btn btn-primary">新增路口週期</button>
                    </div>
                </div>
            </div>
        </div>
